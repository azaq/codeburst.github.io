...
if($zhopa=="apples=6" or $zhopa=="print(apples =6)" or $zhopa=="print(apples= 6)" or $zhopa=="print(apples = 6)"){
...
<form method="POST" action="obr3.php">
...
Давайте теперь разберем переменную типа <span style="color:rgba(255,115,55,1);">string</span>. Синтаксис имеем следующий вид: <span style="color:rgba(255,115,55,1);">имя_переменной="значение"</span>. Значение обязательно должно находиться в кавычках. <span style="color:rgba(255,115,55,1);">Задание</span>: создайте переменную <span style="color:rgba(255,115,55,1);">name</span> типа <span style="color:rgba(255,115,55,1);">string</span> со значением "Monty Python". 
